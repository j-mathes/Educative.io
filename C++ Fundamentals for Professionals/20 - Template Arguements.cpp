...
// Explanation - The class template Matrix uses, by default, an std::vector for holding its elements (line 8). Thanks to the default container, a Matrix can be instantiated (lines 27 and 33) without explicitly specifying a container.
