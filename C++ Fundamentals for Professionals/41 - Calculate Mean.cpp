...
// Explanation
//  We have created a vector, i.e., myVec and an array, i.e., myArr in lines 34 and 43.
//  By using for_each, we have stored the information about the sum, size, and mean in the ContainerInfo by moving the iteration from beginning to end.
//  ContainerInfo is stored for both the vector and array in vecInfo and arrInfo.
